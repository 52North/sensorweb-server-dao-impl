...
public abstract class AbstractAssemblerTest extends TestBase {
    ...
    static class Config extends TestRepositoryConfig<DatasetEntity> {
        ...
        public DbQueryFactory dbQueryFactory() {
            return new DefaultDbQueryFactory("EPSG:4326");
        }

        @Bean
        public DataRepositoryTypeFactory dataRepositoryTypeFactory() {
            return new AnnotationBasedDataRepositoryFactory(null);
        }

        @Bean
        public DefaultIoFactory defaultIoFactory() {
