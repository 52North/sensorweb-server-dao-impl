...
@Component
@Transactional
public class LocationAssembler extends ParameterAssembler<LocationEntity> {

    public LocationAssembler(final ParameterDataRepository<LocationEntity> parameterRepository) {
        super(parameterRepository);
    }

    @Override
    protected Specification<LocationEntity> createFilterPredicate(DbQuery query) {
        return null;
    }
