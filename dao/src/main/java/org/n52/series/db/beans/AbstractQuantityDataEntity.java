 ...
 */
public abstract class AbstractQuantityDataEntity extends DataEntity<BigDecimal> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractQuantityDataEntity.class);
